...
public class CustomerPaymentPlan: Codable {
    ...
    public init(autoCapTime: String? = nil, cardId: String? = nil, currency: String? = nil,
                currentRecurringStatus: Int? = nil, customerId: String? = nil,
                customerPlanId: String? = nil, cycle: String? = nil, id: String? = nil,
                name: String? = nil, nextRecurringDate: String? = nil, planTrackId: String? = nil,
                previousRecurringDate: String? = nil, recurringCount: Int? = nil, recurringCountLeft: Int? = nil,
                startDate: String? = nil, totalCollectedCount: Int? = nil, totalCollectedValue: Int? = nil,
                value: Int? = nil) {
